...
public class RoutingRequest {
  ...
  /** @hidden */
  public RoutingRequest(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  /** @hidden */
  public static long getCPtr(RoutingRequest obj) {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        RoutingRequestModuleJNI.delete_RoutingRequest(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof RoutingRequest) {
      return ((RoutingRequest)obj).swigGetRawPtr() == swigGetRawPtr();
    }
    return false;
  }
 ...
 */
  public RoutingRequest(Projection projection, MapPosVector points) {
    this(RoutingRequestModuleJNI.new_RoutingRequest(Projection.getCPtr(projection), projection, MapPosVector.getCPtr(points), points), true);
  }
 ...
 */
  ...
  long cPtr = RoutingRequestModuleJNI.RoutingRequest_getProjection(swigCPtr, this);
  if (cPtr == 0) {
    return null;
  }
  /** @hidden */
 ...
 */
  public MapPosVector getPoints() { return new MapPosVector(RoutingRequestModuleJNI.RoutingRequest_getPoints(swigCPtr, this), true); }
 ...
 */
  public Variant getPointParameter(int index, String param) { return new Variant(RoutingRequestModuleJNI.RoutingRequest_getPointParameter(swigCPtr, this, index, param), true); }
 ...
 * In addition to Valhalla, SGRE routing engine supports 'geometry_tag_filter' parameter for specifying how to filter matching edges.<br>
 * @param index The routing point index.<br>
 ...
 */
  public void setPointParameter(int index, String param, Variant value) {
    RoutingRequestModuleJNI.RoutingRequest_setPointParameter(swigCPtr, this, index, param, Variant.getCPtr(value), value);
  }
 ...
 */
  public Variant getCustomParameter(String param) { return new Variant(RoutingRequestModuleJNI.RoutingRequest_getCustomParameter(swigCPtr, this, param), true); }
 ...
 */
  public void setCustomParameter(String param, Variant value) {
    RoutingRequestModuleJNI.RoutingRequest_setCustomParameter(swigCPtr, this, param, Variant.getCPtr(value), value);
  }
 ...
 */
  public String toString() {
    return RoutingRequestModuleJNI.RoutingRequest_toString(swigCPtr, this);
  }
 ...
 */
  ...
  public long swigGetRawPtr() {
    return RoutingRequestModuleJNI.RoutingRequest_swigGetRawPtr(swigCPtr, this);
  }
